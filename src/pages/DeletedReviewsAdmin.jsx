...
import { AccountCircle, AccessTime, Search, Clear, AutoDelete } from '@mui/icons-material';
import http from '../http';
import dayjs from 'dayjs';
import UserContext from '../contexts/UserContext';
import global from '../global';

function DeletedReviewsAdmin() {
    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                <Input value={search} placeholder="Search in deleted reviews"
            ...
            <Grid container justifyContent="space-between" alignItems="center">
                ...
                <Typography variant='body2' sx={{ color: 'gray' }}>
                    {reviewList.length === 1 ? '1 Deleted Review' : `${reviewList.length} Deleted Reviews`}
                </Typography>
            </Grid>
                            ...
                            filteredReviews.map((review, i) => {
                                return (
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }} color="text.secondary">
                                        ...
                                        <Typography variant='body2'>
                                            Deleted on {dayjs(review.updatedAt).format('MMMM D, YYYY')}
                                        </Typography>
                                    </Box>
                                    <Box sx={{ mt: 3.5 }}>
                                        <hr />
...
export default DeletedReviewsAdmin;